...
- Generate detailed report in `seo/research/quick-wins-YYYY-MM-DD.md`
...
- `seo/research/quick-wins-YYYY-MM-DD.md` (auto-generated by script)

The command creates:
- `seo/research/priorities-YYYY-MM-DD.md` (summarized top 10 list)
